    ...
    <nav id="sidebar">
        ...
        <div class="p-3 mt-2">
            <ul class="nav flex-column">
                ...
                <li class="nav-item"><a class="nav-link active" href="add_cat.php">📁 Add Category</a></li>
                <li class="nav-item"><a class="nav-link" href="manage_cat.php">⚙️ Manage Categories</a></li>
            </ul>
        </div>
    </nav>
