...
<html lang="en">
<head>
    <title>LMS | Manage Authors</title>
    ...
    <style>
        ...
        .table th { font-weight: 600; text-transform: uppercase; font-size: 0.75rem; letter-spacing: 0.025em; color: #64748b; padding: 15px; }
...
<body>
    ...
    <div id="content">
        <div class="p-4 bg-white shadow-sm d-flex justify-content-between align-items-center">
            <h5 class="mb-0 fw-bold">Author Directory</h5>
            <a href="add_author.php" class="btn btn-primary btn-sm rounded-pill px-3">+ Add New Author</a>
        </div>
                        ...
                        <tbody>
                            <?php
                                ...
                                while ($row = mysqli_fetch_assoc($query_run)){
                                    ?>
                                    <tr>
                                        <td class="fw-medium text-dark"><?php echo htmlspecialchars($row['author_name']); ?></td>
                                        <td class="text-end">
                                            <a href="edit_author.php?aid=<?php echo $row['author_id']; ?>" class="btn-action btn-edit">Edit</a>
                                            <a href="delete_author.php?aid=<?php echo $row['author_id']; ?>" 
